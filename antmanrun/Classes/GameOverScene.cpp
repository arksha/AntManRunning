...
//backgroundSprite->setScaleX(visibleSize.width);
    ...
    if ( myScore >= 30 ) {
        ...
        auto reviveItem = MenuItemImage::create("GameAssets/gamebutton/rebornbefore.png", "GameAssets/gamebutton/rebornafter.png", CC_CALLBACK_1(GameOverScene::ReviveGameScene, this) );
    
        reviveItem->setPosition( Point( visibleSize.width *3/4, visibleSize.height *2/5+20 ));
