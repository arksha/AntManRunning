...
bool OptionScene::init()
{
    ...
    //setbackGround
    auto backgroundSprite = Sprite::create("GameAssets/bgoption.jpg");
    backgroundSprite->setPosition( Point(visibleSize.width/2 + origin.x, visibleSize.height/2 + origin.y));
    this->addChild(backgroundSprite);

    //setPlayItem
    auto menuItem = MenuItemImage::create("GameAssets/home.png", "GameAssets/home.png",
                                          CC_CALLBACK_1(OptionScene::GoToMainMenuScene, this));
    menuItem->setPosition(Point(menuItem->getContentSize() .width/2 + origin.x, menuItem->getContentSize() .height/2 + visibleSize.height-menuItem->getContentSize() .height));
    
    //AddSoundEffectItem
    auto addSoundItem = MenuItemImage::create("GameAssets/plus.png", "sGameAssets/plus.png",
    ...
    auto minusSoundItem = MenuItemImage::create("GameAssets/minus.png", "GameAssets/minus.png",
    ...
    //AddBGMItem
    auto addBGMItem = MenuItemImage::create("GameAssets/plus.png", "GameAssets/plus.png",
    ...
    //MinusBGMItem
    auto minusBGMItem = MenuItemImage::create("GameAssets/minus.png", "GameAssets/minus.png",
    ...
    auto bgmLabel = Sprite::create( "GameAssets/bgmoptiontitle.png" );
    ...
    auto soundEffectLabel = Sprite::create( "GameAssets/soundeffectoptiontitle.png" );
    ...
    CocosDenshion::SimpleAudioEngine::getInstance()->playBackgroundMusic("music/bgmoption.mp3", true);
